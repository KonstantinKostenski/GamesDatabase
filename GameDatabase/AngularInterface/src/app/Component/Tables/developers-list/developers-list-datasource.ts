...
const EXAMPLE_DATA: DevelopersListItem[] = [
  {id: 1, name: 'Hydrogen'},
  {id: 2, name: 'Helium'},
  {id: 3, name: 'Lithium'},
  {id: 4, name: 'Beryllium'},
...
/**
 * Data source for the DevelopersList view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class DevelopersListDataSource extends DataSource<DevelopersListItem> {

  data: DevelopersListItem[] = [];

  constructor(private paginator: MatPaginator, private sort: MatSort, private dataSource: Developer[]) {
    super();
    if (dataSource) {
